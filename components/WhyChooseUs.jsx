...
import { Paintbrush, Award, Sparkles, UserCheck } from "lucide-react";
    ...
    <section className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center max-w-2xl mx-auto mb-20">
        ...
        <p className="text-gray-600 text-lg">
          I simplify the design process by offering a direct, one-on-one
          partnership. No middlemen—just your vision translated into reality
      ...
      >
        {/* Card 1 - Tailored Design (Same Design) */}
        <motion.div
          variants={fadeInUp}
        ...
        >
          <div className="z-10 relative">
            ...
            <p className="text-gray-600 max-w-md text-lg">
              I take the time to understand your unique lifestyle. Every detail
              is hand-picked by me to ensure your home feels exactly like you.
            </p>
          </div>
          ...
          <div className="mt-12 h-16 relative flex items-center">
            <div className="w-full h-1.5 bg-gray-200 rounded-full relative">
              ...
              />
              <div className="absolute top-1/2 left-[85%] -translate-y-1/2 -translate-x-1/2 w-8 h-8 bg-white border-4 border-[#132A13] rounded-full flex items-center justify-center shadow-md"></div>
            </div>
          </div>
        </motion.div>

        {/* Card 2 - Timeless Aesthetics (Same Design) */}
        <motion.div
          variants={fadeInUp}
        ...
        >
          ...
          <p className="text-sm text-gray-500">
            Curated with an eye for detail.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-white/80 text-lg">
            I only take on limited projects at a time to ensure your home gets
            my undivided attention and premium finish.
          </p>
        </motion.div>
        ...
        >
          <div className="flex-1">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-6 shadow-sm">
              <UserCheck className="text-[#132A13]" size={28} />
            </div>
            ...
            <p className="text-gray-600 text-lg max-w-md">
              You work directly with me from the first sketch to the final
              installation. Clear communication and no hidden overheads.
            </p>
          </div>
